...
(document.LocalThemeManagerNative = function () {
  ...
  factory.getActiveFileForEditor = function ($editorContainerNode) {
    ...
    for(var i=0; i < $tabs.length; i++) {
      ...
      // if( $($tabs[i]).attr('aria-selected') === 'true' && $($tabs[i]).attr('class'.match(/active/))) {
  ...
  factory.getEditorsForFile = function (fileName) {
    ...
    console.log('LTMN.getEditorsForFile: editor-left activeFile=' + activeFile);
    ...
    activeFile = this.getActiveFileForEditor($editor);
    console.log('LTMN.getEditorsForFile: editor-center activeFile=' + activeFile);
    ...
    $editor = $('.editor-right');
    activeFile = this.getActiveFileForEditor($editor);
    console.log('LTMN.getEditorsForFile: editor-right activeFile=' + activeFile);
