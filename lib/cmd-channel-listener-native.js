        ...
        if (mutations[i].addedNodes.length > 0) {
          for (var j=0; j < mutations[i].addedNodes.length; j++) {
            ...
            if (typeof addedNode.innerText !== 'undefined'
              ...
              if (cmd.match(/^Theme:/)) {
                ...
                fetch('http://localhost:3000' + '?theme=' + theme)
                  ...
                  .then(r => {
                    ...
                    console.log(`mta-vs-native.MutationObserver: now calling server with themeInfo after applyTheme`);
              ...
              else if (cmd.match(/^getThemeInfo/)){
                console.log(`mta-vs-native.MutationObserver: now handling getThemeInfo`);
                $.post( "localhost:3000", "themeInfo=hello from getThemeInfo");
              }
              //vt end
            }
          }
