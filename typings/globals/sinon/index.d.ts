...
declare namespace Sinon {
    ...
    //declare var Document: any;
    //interface Event: any;
    //interface Document: any;
  //interface Event {};
  //interface Document {};
  //declare var Event: { x: number; y: number;  };
    //vt end
    ...
    interface SinonFakeUploadProgress {
        ...
        //vtaddEventListener(event: string, listener: (e: Event) => any): void;
        //vtremoveEventListener(event: string, listener: (e: Event) => any): void;
        //vtdispatchEvent(event: Event): void;
